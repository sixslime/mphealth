...
execute unless score @s mphealth-hunger_equalibrium matches 0.. run scoreboard players operation @s mphealth-hunger_equalibrium = @s _mphealth-food
...
data modify storage later.psafe:in delay.ticks set from storage mphealth:settings hunger.equalibrium_delay
